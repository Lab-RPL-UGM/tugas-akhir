...
<div class="">
    ...
    <?php if ($ta != false && $ta[0]->progress >= 100 && !isset($sidangInfo[0])) { ?>
        <div class="row">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade in" id="tab_content_<?php echo $record->id_valid_sidang ?>" aria-labelledby="usulan">
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        <strong>
                                                            <h4><?php echo $record->nama_berkas ?></h4>
                                                        </strong>
    ...
    <?php } elseif (isset($sidangInfo[0]->status) && ($sidangInfo[0]->status != 'lulus' || $sidangInfo[0]->status != 'lulus_revisi')) { ?>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <center>
                            <h4>
                                <strong>SUDAH LULUS SIDANG</strong>
                            </h4>
                            <br>
                            <h5>Kamu bisa download data dokumen persetujuan Sidang dibawah ini!</h5>
                            <a href="<?php echo base_url() ?>mahasiswa/sidang/downloadBerkasSidang" class="btn btn-sm btn-danger" target="_blank">
    ...
    <?php } elseif (isset($ta[0]->progress) && $ta[0]->progress != 100) { ?>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <center>
                            ...
                            <br>
                            <h5>Progress bimbingan belum 100% selesai</h5>
                        </center>
                    </div>
                </div>
            </div>
